...
class PlgQuickiconOverrideCheck extends CMSPlugin
{
	...
	public function onGetIcons($context)
	{
		...
		$options  = array(
			'url' => Uri::base() . 'index.php?option=com_templates&view=overrides',
			'ajaxUrl' => Uri::base() . 'index.php?option=com_templates&view=overrides&task=overrides.ajax&' . $token,
		);
		...
		return array(
			array(
				'link'  => 'index.php?option=com_templates&view=overrides',
				'image' => 'fa fa-file',
				'icon'  => '',
